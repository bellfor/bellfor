...
<div id="content">
  ...
  <div class="container-fluid">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-custom-links" data-toggle="tab"><?php echo $tab_custom_links; ?></a></li>
            <li><a href="#tab-top-race-dogs" data-toggle="tab"><?php echo $tab_top_race_dogs; ?></a></li>
          </ul>
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-store">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-fre-delivery"><?php echo $entry_delivery; ?></label>
                    <div class="col-sm-10">
                        <input type="text" name="config_fre_delivery" value="<?php echo $config_fre_delivery; ?>" placeholder="<?php echo $entry_delivery; ?>" id="input-fre-delivery" class="form-control" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-shipping"><?php echo $entry_shipping; ?></label>
                    <div class="col-sm-10">
                        <input type="text" name="config_shipping" value="<?php echo $config_shipping; ?>" placeholder="<?php echo $entry_shipping; ?>" id="input-shipping" class="form-control" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-money-back"><?php echo $entry_money_back; ?></label>
                    <div class="col-sm-10">
                        <input type="text" name="config_money_back" value="<?php echo $config_money_back; ?>" placeholder="<?php echo $entry_money_back; ?>" id="input-money-back" class="form-control" />
                    </div>
                </div>
                <div class="form-group">
            ...
            <fieldset>
              ...
              <div class="tab-pane" id="tab-custom-links">
                  <div class="table-responsive">
                      <table id="custom-links" class="table table-striped table-bordered table-hover">
                          <thead>
                          <tr>
                              <td class="text-left"><?php echo $entry_name_links; ?></td>
                              <td class="text-left"><?php echo $entry_href_links; ?></td>
                              <td></td>
                          </tr>
                          </thead>
                          <tbody>
                          <?php $custom_link_row = 0; ?>
                          <?php foreach ($config_custom_link as $custom_link) { ?>
                              <tr id="custom_link_row<?php echo $custom_link_row; ?>">
                                  <td class="text-left" style="width: 40%;">
                                      <input type="text" name="config_custom_link[<?php echo $custom_link_row; ?>][name]" value="<?php echo $custom_link['name']; ?>" placeholder="<?php echo $entry_custom_link_name; ?>" class="form-control" />
                                  </td>
                                  <td class="text-left">
                                      <div class="input-group">
                                          <input name="config_custom_link[<?php echo $custom_link_row; ?>][href]" value="<?php echo $custom_link['href']; ?>" placeholder="<?php echo $entry_custom_link_href; ?>" class="form-control">
                                      </div>
                                  </td>
                                  <td class="text-left"><button type="button" onclick="$('#custom_link_row<?php echo $custom_link_row; ?>').remove(); minus();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>
                              </tr>
                              <?php $custom_link_row++; ?>
                          <?php } ?>
                          </tbody>
                          ...
                          <tr>
                              <td colspan="2"></td>
                              <td class="text-left"><button type="button" onclick="addCustomLinkRow();" data-toggle="tooltip" title="<?php echo $button_custom_link_add; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i></button></td>
                          </tr>
                          </tfoot>
                      </table>
                  </div>
              </div>
              <div class="tab-pane" id="tab-top-race-dogs">
                  <div class="form-group">
                      <label class="col-sm-2 control-label" for="input-top-race-dogs"><?php echo $entry_top_race_dogs; ?></label>
                      <div class="col-sm-10">
                          <input type="text" name="config_race_dogs" value="" placeholder="<?php echo $entry_top_race_dogs_select; ?>" id="input-top-race-dogs" class="form-control" />
                          <div id="top-race-dogs" class="well well-sm" style="height: 150px; overflow: auto;">
                              <?php foreach ($config_race_dogs as $config_race_dog) { ?>
                                  <div id="top-race-dogs<?php echo $config_race_dog['race_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $config_race_dog['race']; ?>
                                      <input type="hidden" name="config_top_race_dogs[]" value="<?php echo $config_race_dog['race_id']; ?>" />
                                  </div>
                              <?php } ?>
                          </div>
                      </div>
    ...
    <script type="text/javascript">
        $('input[name=\'config_race_dogs\']').autocomplete({
            'source': function(request, response) {
                $.ajax({
                    url: 'index.php?route=extension/race/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
                    dataType: 'json',
            ...
            'select': function(item) {
                $('input[name=\'config_race_dogs\']').val('');

                $('#top-race-dogs' + item['value']).remove();

                $('#top-race-dogs').append('<div id="top-race-dogs' + item['value'] + '"><i class="fa fa-minus-circle"></i> ' + item['label'] + '<input type="hidden" name="config_top_race_dogs[]" value="' + item['value'] + '" /></div>');
            }
        });

        $('#top-race-dogs').delegate('.fa-minus-circle', 'click', function() {
            $(this).parent().remove();
        });
        ...
        function addCustomLinkRow() {
            html  = '<tr id="custom_link_row' + custom_link_row + '">';
            html += '  <td class="text-left" style="width: 20%;"><input type="text" name="config_custom_link[' + custom_link_row + '][name]" value="" placeholder="<?php echo $entry_custom_link_name; ?>" class="form-control" /></td>';
            html += '  <td class="text-left">';
            html += '<div class="input-group"><input name="config_custom_link[' + custom_link_row + '][href]" value="" placeholder="<?php echo $entry_custom_link_href; ?>" class="form-control"></div>';
            html += '  </td>';
            html += '  <td class="text-left"><button type="button" onclick="$(\'#custom_link_row' + custom_link_row + '\').remove(); minus();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>';
            html += '</tr>';

            if (custom_link_row < 15){
                $('#custom-links tbody').append(html);
                custom_link_row++;
            }else{
                return false;
            }
        ...
        function minus(){
            custom_link_row = custom_link_row - 1;
        }
    </script>
  <script type="text/javascript"><!--
