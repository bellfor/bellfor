					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="shortcode[type]" id="input-type" class="form-control">
								<option <?php echo $shortcode['type'] == 'html' ? 'selected' : ''?>>html</option>
								<option <?php echo $shortcode['type'] == 'php' ? 'selected' : ''?>>php</option>
								<option <?php echo $shortcode['type'] == 'js' ? 'selected' : ''?>>js</option>
							</select>							
						</div>
					</div>
				</form>
