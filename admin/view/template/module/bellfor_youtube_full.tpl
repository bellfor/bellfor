  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" class="form-horizontal">
    ...
    <thead>
      ...
      <?php foreach ($modules as $module) { ?>
        ...
        <tr>
        <td width="25%" class="left"><input type="text" name="bellfor_youtube_<?php echo $module_row; ?>_code" value="<?php echo ${'bellfor_youtube_' . $module . '_code'}; ?>" size="40" /></td>
        <td class="left"><select name="bellfor_youtube_<?php echo $module_row; ?>_layout_id">
                <?php foreach ($layouts as $layout) { ?>
                <?php if ($layout['layout_id'] == ${'bellfor_youtube_' . $module . '_layout_id'}) { ?>
        ...
        <td class="left"><select name="bellfor_youtube_<?php echo $module_row; ?>_position">
                <?php if (${'bellfor_youtube_' . $module . '_position'} == 'content_top') { ?>
                <option value="content_top" selected="selected"><?php echo $text_content_top; ?></option>
                <?php } else { ?>
                <option value="content_top"><?php echo $text_content_top; ?></option>
                <?php } ?>
                <?php if (${'bellfor_youtube_' . $module . '_position'} == 'content_bottom') { ?>
                <option value="content_bottom" selected="selected"><?php echo $text_content_bottom; ?></option>
                <?php } else { ?>
                <option value="content_bottom"><?php echo $text_content_bottom; ?></option>
                <?php } ?>
                <?php if (${'bellfor_youtube_' . $module . '_position'} == 'column_left') { ?>
                <option value="column_left" selected="selected"><?php echo $text_column_left; ?></option>
                <?php } else { ?>
                <option value="column_left"><?php echo $text_column_left; ?></option>
                <?php } ?>
                <?php if (${'bellfor_youtube_' . $module . '_position'} == 'column_right') { ?>
    ...
    <tr class="noborder">
        <td colspan="6"><?php echo $entry_help ; ?></td>
    </tr>
    <tr class="noborder">
        <td colspan="6"></td>
    </tr>
...
function addModule() {
	...
	html += '    <td class="left"><select name="bellfor_youtube_' + module_row + '_layout_id">';
	<?php foreach ($layouts as $layout) { ?>
	html += '      <option value="<?php echo $layout['layout_id']; ?>"><?php echo $layout['name']; ?></option>';
	<?php } ?>
	html += '    </select></td>';
	html += '    <td class="left"><select name="bellfor_youtube_' + module_row + '_position">';
