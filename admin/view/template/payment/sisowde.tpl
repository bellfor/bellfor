  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-sisowde" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-sisowde" class="form-horizontal">
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="text" name="sisowde_merchantid" value="<?php echo $sisowde_merchantid; ?>" placeholder="<?php echo $entry_merchantid; ?>" id="input-merchantid" class="form-control" />
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="text" name="sisowde_merchantkey" value="<?php echo $sisowde_merchantkey; ?>" placeholder="<?php echo $entry_merchantkey; ?>" id="input-merchantkey" class="form-control" />
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="sisowde_shopid" value="<?php echo $sisowde_shopid; ?>" placeholder="<?php echo $entry_shopid; ?>" id="input-shopid" class="form-control" />
            </div>
          </div>
          <hr>
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="sisowde_status_success" id="input-order-status" class="form-control">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="sisowde_testmode" id="input-status" class="form-control">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="sisowde_total" value="<?php echo $sisowde_total; ?>" placeholder="<?php echo $entry_total; ?>" id="input-total" class="form-control" />
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="sisowde_totalmax" value="<?php echo $sisowde_totalmax; ?>" placeholder="<?php echo $entry_totalmax; ?>" id="input-totalmax" class="form-control" />
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-geo-zone"><?php echo $entry_geo_zone; ?></label>
            <div class="col-sm-10">
              <select name="sisowde_geo_zone_id" id="input-geo-zone" class="form-control">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="sisowde_status" id="input-status" class="form-control">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="sisowde_sort_order" value="<?php echo $sisowde_sort_order; ?>" placeholder="<?php echo $entry_sort_order; ?>" id="input-sort-order" class="form-control" />
            </div>
          </div>
       </div>
