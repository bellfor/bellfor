  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-sisowovb" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-sisowovb" class="form-horizontal">
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="text" name="sisowovb_merchantid" value="<?php echo $sisowovb_merchantid; ?>" placeholder="<?php echo $entry_merchantid; ?>" id="input-merchantid" class="form-control" />
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="text" name="sisowovb_merchantkey" value="<?php echo $sisowovb_merchantkey; ?>" placeholder="<?php echo $entry_merchantkey; ?>" id="input-merchantkey" class="form-control" />
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="sisowovb_shopid" value="<?php echo $sisowovb_shopid; ?>" placeholder="<?php echo $entry_shopid; ?>" id="input-shopid" class="form-control" />
            </div>
          </div>
          <hr>
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-businessonly"><?php echo $entry_businessonly; ?></label>
            <div class="col-sm-10">
              <select name="sisowovb_businessonly" id="input-status" class="form-control">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-days"><span data-toggle="tooltip" title="<?php echo $help_days; ?>"><?php echo $entry_days; ?></span></label>
            <div class="col-sm-10">
              <input type="text" name="sisowovb_days" value="<?php echo $sisowovb_days; ?>" placeholder="<?php echo $entry_days; ?>" id="input-days" class="form-control" />
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-ovbprefix"><span data-toggle="tooltip" title="<?php echo $help_ovbprefix; ?>"><?php echo $entry_ovbprefix; ?></span></label>
            <div class="col-sm-10">
              <input type="text" name="sisowovb_prefix" value="<?php echo $sisowovb_prefix; ?>" placeholder="<?php echo $entry_ovbprefix; ?>" id="input-prefix" class="form-control" />
            </div>
          </div>
         <div class="form-group">
            <label class="col-sm-2 control-label" for="input-paylink"><?php echo $entry_paylink; ?></label>
            <div class="col-sm-10">
              <select name="sisowovb_paylink" id="input-status" class="form-control">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="sisowovb_status_success" id="input-order-status" class="form-control">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="sisowovb_testmode" id="input-status" class="form-control">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="sisowovb_total" value="<?php echo $sisowovb_total; ?>" placeholder="<?php echo $entry_total; ?>" id="input-total" class="form-control" />
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="sisowovb_totalmax" value="<?php echo $sisowovb_totalmax; ?>" placeholder="<?php echo $entry_totalmax; ?>" id="input-totalmax" class="form-control" />
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-geo-zone"><?php echo $entry_geo_zone; ?></label>
            <div class="col-sm-10">
              <select name="sisowovb_geo_zone_id" id="input-geo-zone" class="form-control">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="sisowovb_status" id="input-status" class="form-control">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="sisowovb_sort_order" value="<?php echo $sisowovb_sort_order; ?>" placeholder="<?php echo $entry_sort_order; ?>" id="input-sort-order" class="form-control" />
            </div>
          </div>
       </div>
