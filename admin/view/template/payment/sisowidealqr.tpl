  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-sisowidealqr" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-sisowidealqr" class="form-horizontal">
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="text" name="sisowidealqr_merchantid" value="<?php echo $sisowidealqr_merchantid; ?>" placeholder="<?php echo $entry_merchantid; ?>" id="input-merchantid" class="form-control" />
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="text" name="sisowidealqr_merchantkey" value="<?php echo $sisowidealqr_merchantkey; ?>" placeholder="<?php echo $entry_merchantkey; ?>" id="input-merchantkey" class="form-control" />
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="sisowidealqr_shopid" value="<?php echo $sisowidealqr_shopid; ?>" placeholder="<?php echo $entry_shopid; ?>" id="input-shopid" class="form-control" />
            </div>
          </div>
          <hr>
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="sisowidealqr_status_success" id="input-order-status" class="form-control">
                <?php foreach ($order_statuses as $order_status) { ?>
                <?php if ($order_status['order_status_id'] == $sisowidealqr_status_success) { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="sisowidealqr_testmode" id="input-status" class="form-control">
                <?php if ($sisowidealqr_testmode == "true") { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="sisowidealqr_total" value="<?php echo $sisowidealqr_total; ?>" placeholder="<?php echo $entry_total; ?>" id="input-total" class="form-control" />
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="sisowidealqr_totalmax" value="<?php echo $sisowidealqr_totalmax; ?>" placeholder="<?php echo $entry_totalmax; ?>" id="input-totalmax" class="form-control" />
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-geo-zone"><?php echo $entry_geo_zone; ?></label>
            <div class="col-sm-10">
              <select name="sisowidealqr_geo_zone_id" id="input-geo-zone" class="form-control">
                <option value="0"><?php echo $text_all_zones; ?></option>
                <?php foreach ($geo_zones as $geo_zone) { ?>
                <?php if ($geo_zone['geo_zone_id'] == $sisowidealqr_geo_zone_id) { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="sisowidealqr_status" id="input-status" class="form-control">
                <?php if ($sisowidealqr_status) { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="sisowidealqr_sort_order" value="<?php echo $sisowidealqr_sort_order; ?>" placeholder="<?php echo $entry_sort_order; ?>" id="input-sort-order" class="form-control" />
            </div>
          </div>
       </div>
