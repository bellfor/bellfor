  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-sisowpp" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-sisowpp" class="form-horizontal">
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="text" name="sisowpp_merchantid" value="<?php echo $sisowpp_merchantid; ?>" placeholder="<?php echo $entry_merchantid; ?>" id="input-merchantid" class="form-control" />
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="text" name="sisowpp_merchantkey" value="<?php echo $sisowpp_merchantkey; ?>" placeholder="<?php echo $entry_merchantkey; ?>" id="input-merchantkey" class="form-control" />
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="sisowpp_shopid" value="<?php echo $sisowpp_shopid; ?>" placeholder="<?php echo $entry_shopid; ?>" id="input-shopid" class="form-control" />
            </div>
          </div>
          <hr>
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="sisowpp_paymentfee" value="<?php echo $sisowpp_paymentfee; ?>" placeholder="<?php echo $entry_paymentfee; ?>" id="input-paymentfee" class="form-control" />
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-sisowppfee_tax"><span data-toggle="tooltip" title="<?php echo $help_tax_class; ?>"><?php echo $entry_tax_class; ?></span></label>
            <div class="col-sm-10">
              <select name="sisowppfee_tax" id="input-sisowppfee_tax" class="form-control">
					<option value=""><?php echo $text_none; ?></option>
					<?php foreach ($tax_classes as $tax_class) { ?>
					<?php if ($tax_class['tax_class_id'] == $sisowppfee_tax) { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="sisowpp_status_success" id="input-order-status" class="form-control">
                <?php foreach ($order_statuses as $order_status) { ?>
                <?php if ($order_status['order_status_id'] == $sisowpp_status_success) { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="sisowpp_testmode" id="input-status" class="form-control">
                <?php if ($sisowpp_testmode == "true") { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="sisowpp_total" value="<?php echo $sisowpp_total; ?>" placeholder="<?php echo $entry_total; ?>" id="input-total" class="form-control" />
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="sisowpp_totalmax" value="<?php echo $sisowpp_totalmax; ?>" placeholder="<?php echo $entry_totalmax; ?>" id="input-totalmax" class="form-control" />
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-geo-zone"><?php echo $entry_geo_zone; ?></label>
            <div class="col-sm-10">
              <select name="sisowpp_geo_zone_id" id="input-geo-zone" class="form-control">
                <option value="0"><?php echo $text_all_zones; ?></option>
                <?php foreach ($geo_zones as $geo_zone) { ?>
                <?php if ($geo_zone['geo_zone_id'] == $sisowpp_geo_zone_id) { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="sisowpp_status" id="input-status" class="form-control">
                <?php if ($sisowpp_status) { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="sisowpp_sort_order" value="<?php echo $sisowpp_sort_order; ?>" placeholder="<?php echo $entry_sort_order; ?>" id="input-sort-order" class="form-control" />
            </div>
          </div>
       </div>
       <div class="tab-pane" id="tab-register">
          ...
          <hr>
          <div class="form-group required">
            <div class="col-sm-2"><?php echo $text_register_paypal; ?></div>
            <div class="col-sm-10"><a href="https://www.paypal.com/nl/mrb/pal=EU5MXBYS54FEC" target="_blank" data-toggle="tooltip" title="<?php echo $text_register_paypal; ?>" class="btn btn-warning"><i class="fa fa-user"> <?php echo $button_register; ?> <?php echo $text_paypal; ?></i></a> <a href="https://www.paypal.com/signin/" target="_blank" data-toggle="tooltip" title="<?php echo $text_login_paypal; ?>" class="btn btn-info"><i class="fa fa-sign-in"> <?php echo $text_paypal; ?> <?php echo $button_login; ?> </i></a><br /><?php echo $help_pp_add_info; ?></div>
          </div>
          <div class="form-group">
            <div class="col-sm-2"><?php echo $text_login_paypal; ?></div>
            <div class="col-sm-10"><?php echo $help_sisow_login; ?></div>
          </div>
          <hr>
          <div class="form-group">
          ...
          <hr>
          <div class="form-group">
            <div class="col-sm-2"><?php echo $text_add_pp; ?></div>
            <div class="col-sm-10"><?php echo $help_add_pp; ?> <img src="view/image/payment/sisow/sisow-add-paypal.jpg" class="img-responsive" /></div>
          </div>
          <hr>
          <div class="form-group">
