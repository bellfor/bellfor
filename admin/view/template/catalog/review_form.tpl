    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-review" class="form-horizontal">
		  ...
		  <div class="form-group">
            <label class="col-sm-2 control-label" for="input-store-id"><?php echo $entry_store_id; ?></label>
            <div class="col-sm-10">
			  ...
			  <select name="store_id" id="input-store-id" class="form-control">
				...
				<?php if($store_id == 0) { ?>
                <option value="0" selected="selected">Bellfor Germany (default)</option>               
                <?php } else { ?>
				<option value="0" >Bellfor Germany (default)</option>
				<?php } ?>
