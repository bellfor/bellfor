          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
				  ...
				  <td class="text-left"><?php if ($sort == 'r.store_id') { ?>
                    <a href="<?php echo $sort_store_id; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_store_id; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_store_id; ?>"><?php echo $column_store_id; ?></a>
                    <?php } ?></td>		
              ...
              <tbody>
				...
				<?php if($store['store_id'] == $review['store_id']) { ?>
                <?php echo $store['name']; ?>
				<?php } ?>
				...
				<?php if($review['store_id'] == 0) { ?>
                Bellfor Germany (default)
				<?php } ?> 
