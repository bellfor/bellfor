          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="tab-pane" id="tab-feed">
                  <div class="form-group">
                      <ul class="nav nav-tabs" id="language-without-weight">
                          <?php foreach ($languages as $language) { ?>
                              <li><a href="#language-without-weight<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
                          <?php } ?>
                      </ul>
                      <div class="tab-content">
                          <?php foreach ($languages as $language) { ?>
                              <div class="tab-pane" id="language-without-weight<?php echo $language['language_id']; ?>">
                                  <label class="col-sm-2 control-label" for="input-name-without-weight<?php echo $language['language_id']; ?>">Product name without weight</label>
                                  <div class="col-sm-10">
                                      <input type="text" name="product_name_without_weight[<?php echo $language['language_id']; ?>]" value="<?php echo isset($name_without_weight[$language['language_id']]) ? $name_without_weight[$language['language_id']] : ''; ?>" placeholder="Entry product name without weight" id="input-name-without-weight<?php echo $language['language_id']; ?>" class="form-control" />
                                  </div>
                              </div>
                          <?php } ?>
                      </div>
                  ...
                  <div class="form-group">
                      <label class="col-sm-2 control-label" for="input-parent-product-id">Parent product id</label>
                      <div class="col-sm-10">
                          <input type="text" name="product_parent_id" value="<?php echo isset($parent_product_id) ? $parent_product_id : ''; ?>" placeholder="Entry parent product id" id="input-parent-product-id" class="form-control" />
                          <?php if (isset($error_product_parent_id)) { ?>
...
<!--                            <input type="text" name="prices[--><?php //echo $item['price_id'];?><!-----><?php //echo $item['store_id'];?><!--]" value="--><?php //echo $item['value']; ?><!--" placeholder="--><?php //echo $entry_price; ?><!--" id="input-price" class="form-control" />-->
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label">Emails enter is required</label>
                    <div class="col-sm-10">
                        <label class="radio-inline">
                            <?php if ($email_required) { ?>
                                <input type="radio" name="email_required" value="1" checked="checked" />
                                <?php echo $text_yes; ?>
                            <?php } else { ?>
                        ...
                        <label class="radio-inline">
                            <?php if (!$email_required) { ?>
                                <input type="radio" name="email_required" value="0" checked="checked" />
                                <?php echo $text_no; ?>
                            <?php } else { ?>
                                <input type="radio" name="email_required" value="0" />
                                <?php echo $text_no; ?>
                            <?php } ?>
                        </label>
                    </div>
