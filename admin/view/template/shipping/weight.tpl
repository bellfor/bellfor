            ...
            <div class="col-sm-10">
              <div class="tab-content">
                ...
                <div class="tab-pane" id="tab-geo-zone<?php echo $geo_zone['geo_zone_id']; ?>">
				  ...
				  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-free<?php echo $geo_zone['geo_zone_id']; ?>">Mindestbestellbetrag</label>
                    <div class="col-sm-10">
					<input type="text" name="weight_<?php echo $geo_zone['geo_zone_id']; ?>_free" value="<?php echo ${'weight_' . $geo_zone['geo_zone_id'] . '_free'}; ?>" placeholder="z.B. 10" id="input-free<?php echo $geo_zone['geo_zone_id']; ?>" class="form-control" />
                    </div>
                  </div>
				   <!-- // end fixed by oppo webiprog.com  25.12.2017 -->
