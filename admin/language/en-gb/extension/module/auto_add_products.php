...
$_['heading_triggers']					= 'Triggers';
$_['help_triggers']						= 'Choose the product(s) to auto-add, then add rules to determine the triggering factors.<br />For example, if you want to auto-add a "Screen Protector" item when a product from the "Phones" category is added to the cart, you can choose "Screen Protector" in the middle column, and then add a rule like this: "Category is Phones"';

$_['column_products_to_auto_add']		= 'Products to Auto-Add';

$_['help_trigger_name']					= 'The name of the trigger, for admin use only. To temporarily disable the trigger, enter a hyphen before the name, like this: -My Trigger';
$_['entry_auto_added_free']				= 'Auto-Added Products are Free:';
$_['entry_auto_added_removable']		= 'Auto-Added Products are Removable:';
$_['entry_auto_remove_products']		= 'Auto-Remove Products When Rules Not Met:';
$_['help_trigger_auto_remove_products']			= 'NOTE: This will make the auto-added product unpurchasable by itself. If you need this enabled but need the auto-added product still purchasable on its own, you should duplicate the product, assign the free version here, and let the duplicate version be purchasable normally.';

$_['button_add_trigger']				= 'Add Trigger';
