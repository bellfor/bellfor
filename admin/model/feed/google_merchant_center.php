...
if ($query->rows){
	...
	public function saveProduct($product_id,$gender,$age_group,$color,$product_type) {
		$this->db->query("INSERT INTO `" . DB_PREFIX . "feed_manager_product` SET product_id = '".$product_id."', gender = '".$gender."', age_group = '".$age_group."', color = '".$color."', product_type = '".$product_type."' ON DUPLICATE KEY UPDATE gender = '".$gender."', age_group = '".$age_group."', color = '".$color."', product_type = '".$product_type."'");
	}
