...
class ModelCatalogInformation extends Model {
	public function addInformation($data) {
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "information SET sort_order = '" . (int)$data['sort_order'] . "', bottom = '" . (isset($data['bottom']) ? (int)$data['bottom'] : 0) . "', status = '" . (int)$data['status'] . "', race_id = '" . (int)$data['race_id'] . "', status_consultant = '" . (int)$data['status_consultant'] . "', noindex = '" . (int)$data['noindex'] . "'");
