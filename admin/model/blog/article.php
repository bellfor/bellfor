...
class ModelBlogArticle extends Model {
    public function addArticle($data) {
        ...
        $this->db->query("INSERT INTO " . DB_PREFIX . "article SET status = '" . (int)$data['status'] . "', race_id = '" . (int)$data['race_id'] . "', status_consultant = '" . (int)$data['status_consultant'] . "', noindex = '" . (int)$data['noindex'] . "', sort_order = '" . (int)$data['sort_order'] . "', date_added = NOW()");
    ...
    public function editArticle($article_id, $data) {
        ...
        $this->db->query("UPDATE " . DB_PREFIX . "article SET status = '" . (int)$data['status'] . "', race_id = '" . (int)$data['race_id'] . "', status_consultant = '" . (int)$data['status_consultant'] . "', noindex = '" . (int)$data['noindex'] . "', sort_order = '" . (int)$data['sort_order'] . "', date_modified = NOW() WHERE article_id = '" . (int)$article_id . "'");
