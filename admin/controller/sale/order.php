...
class ControllerSaleOrder extends Controller {
    ...
    $data['change_status_link'] = $this->url->link('sale/order/status_change', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		$data['error_select_status'] = $this->language->get('error_select_status');
  ...
  public function status_change() {
    ...
    if (isset($this->request->post['selected'])) {
      ...
      $this->model_sale_order->updateOrdersStatus($this->request->post['change_status'], $this->request->post['selected']);
