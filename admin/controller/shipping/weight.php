...
class ControllerShippingWeight extends Controller {
	...
	public function index() {
		...
		foreach ($geo_zones as $geo_zone) {
			...
			if (isset($this->request->post['weight_' . $geo_zone['geo_zone_id'] . '_free'])) {
				$data['weight_' . $geo_zone['geo_zone_id'] . '_free'] = $this->request->post['weight_' . $geo_zone['geo_zone_id'] . '_free'];
			} else {
				$data['weight_' . $geo_zone['geo_zone_id'] . '_free'] = $this->config->get('weight_' . $geo_zone['geo_zone_id'] . '_free');
			}
