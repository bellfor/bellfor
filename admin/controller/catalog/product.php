...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
        ...
        if (isset($this->error['product_parent_id'])) {
            $data['error_product_parent_id'] = $this->error['product_parent_id'];
        } else {
            $data['error_product_parent_id'] = null;
        }
        ...
        $product_feed = $this->model_catalog_product->getProductFeed($this->request->get['product_id']);

        foreach ($product_feed as $value) {
            if (!empty($value['parent_product_id'])) {
                $data['parent_product_id'] = $value['parent_product_id'];
            } else {
                $data['parent_product_id'] = '';
            }

            if (!empty($value['name_without_weight'])) {
                $data['name_without_weight'][$value['language_id']] = $value['name_without_weight'];
            } else {
                $data['name_without_weight'][$value['language_id']] = '';
            }
	...
	protected function validateForm() {
        ...
        if (!(int)$this->request->post['product_parent_id'] && !empty($this->request->post['product_parent_id'])) {
            $this->error['product_parent_id'] = 'Must be number!';
        }
