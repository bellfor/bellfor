...
class ControllerCatalogReview extends Controller {
	...
	protected function getList() {
		...
		$data['enabled'] = $this->url->link('catalog/review/enable', 'token=' . $this->session->data['token'] . $url, 'SSL');
        $data['disabled'] = $this->url->link('catalog/review/disable', 'token=' . $this->session->data['token'] . $url, 'SSL');
		
		$this->load->model('setting/store'); 
		
		$stores_dump = $this->model_setting_store->getStores();

		foreach ($stores_dump as $result) {
			$data['stores'][] = array(
		...
		$data['column_store_id'] = $this->language->get('column_store_id');
		...
		$data['sort_store_id'] = $this->url->link('catalog/review', 'token=' . $this->session->data['token'] . '&sort=r.store_id' . $url, 'SSL');
