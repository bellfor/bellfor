...
class ControllerSettingStore extends Controller {
    ...
    public function getForm() {
        ...
        } elseif (isset($store_info['config_fre_delivery'])) {
            $data['config_fre_delivery'] = $store_info['config_fre_delivery'];
        } else {
            $data['config_fre_delivery'] = '';
        }

        if (isset($this->request->post['config_shipping'])) {
            $data['config_shipping'] = $this->request->post['config_shipping'];
        } elseif (isset($store_info['config_shipping'])) {
            $data['config_shipping'] = $store_info['config_shipping'];
        } else {
            $data['config_shipping'] = '';
        }

        if (isset($this->request->post['config_money_back'])) {
            $data['config_money_back'] = $this->request->post['config_money_back'];
        } elseif (isset($store_info['config_money_back'])) {
            $data['config_money_back'] = $store_info['config_money_back'];
        } else {
            $data['config_money_back'] = '';
        }
        ...
        } elseif ($this->config->get('config_product_limit')) {
        ...
        } elseif ($this->config->get('config_tax_default')) {
        ...
        } elseif ($this->config->get('config_tax_customer')) {
        ...
        } elseif ($this->config->get('config_customer_price')) {
        ...
        } elseif ($this->config->get('config_account_id')) {
        ...
        } elseif ($this->config->get('config_cart_weight')) {
        ...
        } elseif ($this->config->get('config_checkout_guest')) {
        ...
        } elseif ($this->config->get('config_checkout_id')) {
        ...
        } elseif (isset($store_info['config_custom_link'])) {
            $data['config_custom_link'] = $store_info['config_custom_link'];
        } else {
            $data['config_custom_link'] = '';
        }
