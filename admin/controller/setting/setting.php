...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['entry_name_links'] = $this->language->get('entry_name_links');
        $data['entry_href_links'] = $this->language->get('entry_href_links');
        $data['entry_custom_link_name'] = $this->language->get('entry_custom_link_name');
        $data['entry_custom_link_href'] = $this->language->get('entry_custom_link_href');

        $data['entry_top_race_dogs'] = $this->language->get('entry_top_race_dogs');
        $data['entry_top_race_dogs_select'] = $this->language->get('entry_top_race_dogs_select');

        $data['entry_delivery'] = $this->language->get('entry_delivery');
        $data['entry_shipping'] = $this->language->get('entry_shipping');
        $data['entry_money_back'] = $this->language->get('entry_money_back');
        ...
        $data['tab_top_race_dogs'] = $this->language->get('tab_top_race_dogs');
        ...
        if (isset($this->request->post['config_fre_delivery'])) {
            $data['config_fre_delivery'] = $this->request->post['config_fre_delivery'];
        } else {
            $data['config_fre_delivery'] = $this->config->get('config_fre_delivery');
        }

        if (isset($this->request->post['config_shipping'])) {
            $data['config_shipping'] = $this->request->post['config_shipping'];
        } else {
            $data['config_shipping'] = $this->config->get('config_shipping');
        }

        if (isset($this->request->post['config_money_back'])) {
            $data['config_money_back'] = $this->request->post['config_money_back'];
        } else {
        ...
        if (isset($this->request->post['config_custom_link'])) {
            $data['config_custom_link'] = $this->request->post['config_custom_link'];
        } else {
            $data['config_custom_link'] = $this->config->get('config_custom_link');
        }

        $this->load->model('extension/race');

        if (isset($this->request->post['config_race_dogs'])) {
            $data['config_race_dogs'] = $this->model_extension_race->getRaces($this->request->post['config_top_race_dogs']);
        } elseif ($this->config->get('config_top_race_dogs')) {
            $data['config_race_dogs'] = $this->model_extension_race->getRaces($this->config->get('config_top_race_dogs'));
        } else {
            $data['config_race_dogs'] = array();
        }
