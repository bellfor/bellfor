...
class GMIntraship {
	...
	public function __construct() {
		...
		$this->_config = array(
			...
			'ekp' => '6282518948',
			'user' => 'marsapet',
			'password' => 'Aquaris+2016',
			'shipper_name' => 'Bellfor',
			'shipper_street' => 'Apostelpfad',
			'shipper_house' => '7',
			'shipper_postcode' => '53332',
			'shipper_city' => 'Bornheim',
			'shipper_contact' => 'Marcel Hoffmann',
			'shipper_email' => 'kontakt@bellfor.info',
			'shipper_phone' => '02222-8039975',
			'cod_account_holder' => 'Marsapet GmbH',
			'cod_account_number' => '1932517632',
			'cod_bank_number' => '37050198',
			'cod_bank_name' => 'Sparkasse  KolnBonn',
			'cod_iban' => 'DE49370501981932517632',
			'cod_bic' => 'COLSDE33XXX',
			'status_id_sent' => 0,
			'status_id_storno' => 0,
			'zone_1_countries' => 'DE',
	...
	{
$fp = fopen('numbrs.txt', 'a+');fwrite($fp, $orders_id."||".$trackingNumber."\n");fclose($fp);
	}
