...
$_['heading_title'] = 'Empfehlungs-Programm';
$_['heading_referral_form'] = 'Empfehlungsformular senden';
$_['heading_referral_table'] = 'Ihre Empfehlungen';

$_['text_account'] = 'Konto';
$_['text_referral'] = 'Empfehlungsprogramm';

/*
$_['html_info_old'] = 'Wenn Sie einen Freund an den Shop weiterempfehlen, erhalten Sie {sending_reward} {reward_type} und Ihr Freund erhält einen Gutschein über {coupon_discount}.  Wenn Ihr Freund den Gutschein einlöst, erhalten Sie eine zusätzliche {coupon_redeemed_reward} {reward_type}.';
*/

$_['html_info'] = 'Wenn Sie einen Ihrer Freunde unseren Bellfor Shop weiterempfehlen, erhält Ihr Freund einen Gutschein über {coupon_discount} Nachlass. Wenn Ihr Freund diesen Gutschein einlöst, erhalten Sie einen Gutschein über {coupon_redeemed_reward}% Nachlass. Gerne können Sie unseren Onlineshop auch an mehrere Freunde weiterempfehlen. <a href="https://www.bellfor.info/kunde-wirbt-kunde.html" style="color:#333;text-decoration: underline;">Lesen Sie mehr über das Programm hier</a>';
