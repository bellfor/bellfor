      ...
      <form>
        ...
        <table class="table table-bordered table-hover">
          ...
          <tfoot>
            <tr>
              <td colspan="2">
                <button class="btn btn-success" onclick="sendReferralBellfor(this);" type="button"><i class="fa fa-envelope"></i> <?php echo $lng['button_send']; ?></button>
...
function getReferrals(page) {
  $('.referral-coupon-table').load('index.php?route=module/referral_bellfor/getReferrals&page=' + page);
} //getReferrals end
...
function sendReferralBellfor(obj) {
  ...
  $.ajax({
    url: 'index.php?route=module/referral_bellfor/sendReferral',
