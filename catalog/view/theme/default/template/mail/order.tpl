...
<div style="width: 680px;"><a href="<?php echo $store_url; ?>" title="<?php echo $store_name; ?>"><img src="<?php echo $store_url; ?>/catalog/view/theme/default/image/companyname_small.png" alt="<?php echo $store_name; ?>" style="margin-bottom: 20px; border: none;" /></a>
...
<table style="border-collapse:collapse;width:100%;border-top:1px solid #dddddd;border-left:1px solid #dddddd;margin-bottom:20px">
    <thead>
      <tr>
        <td style="font-size:12px;border-right:1px solid #dddddd;border-bottom:1px solid #dddddd;background-color:#efefef;font-weight:bold;text-align:left;padding:7px;color:#222222">Anmerkung</td>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td style="font-size:12px;border-right:1px solid #dddddd;border-bottom:1px solid #dddddd;text-align:left;padding:7px">Bitte angezeigten Gesamtbetrag auf nachstehendes Bankkonto überweisen.<br>
<br>
Dies ist eine Vorkasse Bestellung.<br>
Unsere Bankverbindung:<br>
Marsapet GmbH<br>
IBAN: DE49 3705 0198 1932 5176 32<br>
BIC: COLSDE33XXX<br>
