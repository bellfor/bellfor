  ...
  <div id="collapse-coupon" class="panel-collapse collapse">
    <div class="panel-body">
      ...
      <div class="input-group">
        ...
        <input type="button" value="<?php echo $button_coupon; ?>" id="button-coupon" data-loading-text="<?php echo $text_loading; ?>"  class="button_blue button_set button_set__fix" style="height: 34px !important; font-size: 14px"/>
        </span></div>
