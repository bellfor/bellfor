...
<form id="payment" class="form-horizontal">
  <fieldset>
    ...
    <?php if (!$company) { ?>
    <?php if ($iso_code_3 == 'DEU' || $iso_code_3 == 'NLD' || $iso_code_3 == 'AUT') { ?>
    ...
    <div class="form-group required">
      ...
      <div class="col-sm-10">
        <div class="wrap_radio_payment">
          <div class="radio">
            <input id="gender_" type="radio" name="gender" value="1" >
            <label for="gender_"><?php echo $text_male; ?></label>
            <input id="gender_1" type="radio" name="gender" value="0" >
            <label for="gender_1"><?php echo $text_female; ?></label>  
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="checkbox_wraper">
      <div class="checkbox_belf">
        <input type="checkbox" value="1" name="deu_terms" id="shipping_1" />
        <label for="shipping_1"></label> 
      </div>
      <p>Mit der Übermittlung der für die Abwicklung des Rechnungskaufes und einer Identitäts - und Bonitätsprüfung erforderlichen
      Daten an Klarna bin ich einverstanden. Meine <a href="https://online.klarna.com/consent_de.yaws" target="_blank">Einwilligung</a> kann ich jederzeit mit Wirkung für die Zukunft widerrufen.</p> 
    </div>
    <?php } ?>
  </fieldset>
</form>
<div class="buttons">
  <div class="pull-right">
    <button id="button-confirm" data-loading-text="<span class='button-outer'><span class='button-inner'><?php echo $text_loading; ?></span></span>" class="button_blue button_set"><span class="button-outer"><span class="button-inner"><?php echo $button_confirm; ?></span></span></button>
  </div>
</div>
<script type="text/javascript"><!--
$('#button-confirm').on('click', function() {
	$.ajax({
		url: 'index.php?route=payment/klarna_invoice_pro/send',
		type: 'post',
