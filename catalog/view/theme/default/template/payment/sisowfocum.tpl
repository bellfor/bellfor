...
<div><img src="catalog/view/theme/default/image/sisow/sisow-focum.png" title="Focum" alt="Focum" /></div>
<form id="payment" class="form-horizontal">
  <fieldset>
	...
	<div class="form-group required">
	  <label class="col-sm-3 control-label" for="sisowcoc"><?php echo $text_iban; ?></label>
		<div class="col-sm-9">
			<input type="text" id="sisowiban" name="sisowiban" class="form-control" maxlength="32" value="" />
		</div>
	</div>
  <fieldset>
</form>
<div class="col-sm-9"><?php if ($text_fee) { ?><?php echo $text_paymentfee; ?><?php } ?></div>
<div class="buttons">
