...
<div><?php echo $text_klarna_account; ?> - <?php echo $text_monthly; ?> / <?php echo $text_month; ?></div>
<div><a href="<?php echo $text_terms_url; ?><?php echo $text_klarnaid; ?>" onclick="window.open(this.href, 'sisowklaacc', 'resizable=no,status=no,location=no,toolbar=no,menubar=no,fullscreen=no,scrollbars=yes,dependent=no,width=660,height=500'); return false;"><?php echo $text_klarna_terms; ?></a></div>
<div class="buttons">
...
$('#button-confirm').on('click', function() {
	$.ajax({
		url: 'index.php?route=payment/sisowklaacc/redirectbank',
		type: 'post',
		data: $('#payment :input'),
		dataType: 'json',
		cache: false,
