<form class="form-horizontal">
  ...
  <div class="buttons">
    <div class="pull-right">
      <button id="button-guest-shipping" data-loading-text="<span class='button-outer'><span class='button-inner'><?php echo $text_loading; ?></span></span>" class="button_blue button_set"><span class="button-outer"><span class="button-inner"><?php echo $button_continue; ?></span></span></button>
    </div>
  </div>
</form>
