        ...
        <div id="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>">
          ...
          <div class="checkbox_wraper">
            ...
            <div class="checkbox_belf">
              <input type="checkbox" value="<?php echo $custom_field_value['custom_field_value_id']; ?>" id="checkbox_belf" name="custom_field[<?php echo $custom_field['location']; ?>][<?php echo $custom_field['custom_field_id']; ?>][]" checked="checked"/>
              <label for="checkbox_belf"></label> 
            </div> <p><?php echo $custom_field_value['name']; ?></p>
            
            <?php } else { ?>
            <div class="checkbox_belf">
              <input type="checkbox" value="<?php echo $custom_field_value['custom_field_value_id']; ?>" id="checkbox_belf" name="custom_field[<?php echo $custom_field['location']; ?>][<?php echo $custom_field['custom_field_id']; ?>][]" />
              <label for="checkbox_belf"></label> 
            </div> <p><?php echo $custom_field_value['name']; ?></p>
...
<?php if ($shipping_address) { ?>
  <input type="checkbox" value="1" id="checkbox_belf" name="shipping_address" checked="checked"/>
  <?php } else { ?>
  <input type="checkbox" value="1" id="checkbox_belf" name="shipping_address"/>
  <?php } ?>
  <label for="checkbox_belf"></label> 
...
<div class="buttons">
  <div class="pull-right">
       <button id="button-guest" data-loading-text="<span class='button-outer'><span class='button-inner'><?php echo $text_loading; ?></span></span>" class="button_blue button_set"><span class="button-outer"><span class="button-inner"><?php echo $button_continue; ?></span></span></button>
  </div>
</div>
