<form class="form-horizontal">
  ...
  <div class="wrap_radio_payment">
    <div class="radio">
      <input id="shipping_address_" type="radio" name="shipping_address" value="existing" checked="checked">
      <label for="shipping_address_"><?php echo $text_address_existing; ?></label> 
    </div>
  </div>
  ...
  <div class="wrap_radio_payment">
    <div class="radio">
      <input id="shipping_address_1" type="radio" name="shipping_address" value="new" >
      <label for="shipping_address_1"><?php echo $text_address_new; ?></label> 
    </div>
  </div>
  ...
  <div class="buttons clearfix">
    <div class="pull-right">
      ...
      <!-- <button id="button-shipping-address" data-loading-text="<span class='button-outer'><span class='button-inner'><?php echo $text_loading; ?></span></span>" class="button_blue button_set"><span class="button-outer"><span class="button-inner"><?php echo $button_continue; ?></span></span></button> -->

      <input type="button" value="<?php echo $button_continue; ?>" id="button-shipping-address" data-loading-text="<?php echo $text_loading; ?>" class="button_blue button_set button_set__fix" />
