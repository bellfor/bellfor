  ...
  <div class="col-sm-6">
    <fieldset id="account">
      ...
      <div class="form-group" style="display: <?php echo (count($customer_groups) > 1 ? 'block' : 'none'); ?>;">
        ...
        <div class="radio">
          <input id="male1" type="radio" name="customer_group_id" value="<?php echo $customer_group['customer_group_id']; ?>" checked="checked">
          <label for="male1"><?php echo $customer_group['name']; ?></label>
        </div>         
        <?php } else { ?>  
		<div class="radio"> 
          <input id="male1" type="radio" name="customer_group_id" value="<?php echo $customer_group['customer_group_id']; ?>">
          <label for="male1"><?php echo $customer_group['name']; ?></label>
        </div>
        <?php } ?>
        <?php } ?>
      ...
      <div id="payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-group custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
        ...
        <div id="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>">
          <?php foreach ($custom_field['custom_field_value'] as $custom_field_value) { ?>
          <div class="radio">
            <input id="male2" type="radio" name="custom_field[<?php echo $custom_field['location']; ?>][<?php echo $custom_field['custom_field_id']; ?>]" value="<?php echo $custom_field_value['custom_field_value_id']; ?>">
            <label for="male2"><?php echo $custom_field_value['name']; ?></label>
            <!-- <label>
        ...
        <div id="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>">
          ...
          <div class="checkbox_wraper">
            <div class="checkbox_belf">
              <input type="checkbox" value="<?php echo $custom_field_value['custom_field_value_id']; ?>" id="checkbox_belf1" name="custom_field[<?php echo $custom_field['location']; ?>][<?php echo $custom_field['custom_field_id']; ?>][]" checked="checked"/>
              <label for="checkbox_belf1"></label> 
            </div> <p><?php echo $custom_field_value['name']; ?></p>
            <!-- <label>
    ...
    <fieldset id="address">
      ...
      <div id="payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-group custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
        ...
        <div id="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>">
          ...
          <div class="checkbox_wraper">
          <div class="checkbox_belf">
              <input type="checkbox" value="<?php echo $custom_field_value['custom_field_value_id']; ?>" id="checkbox_belf2" name="custom_field[<?php echo $custom_field['location']; ?>][<?php echo $custom_field['custom_field_id']; ?>][]" />
              <label for="checkbox_belf2"></label> 
            </div> <p><?php echo $custom_field_value['name']; ?></p>
            <!-- <label>
              <input type="checkbox" name="custom_field[<?php echo $custom_field['location']; ?>][<?php echo $custom_field['custom_field_id']; ?>][]" value="<?php echo $custom_field_value['custom_field_value_id']; ?>" />
              <?php echo $custom_field_value['name']; ?></label> -->
...
<div class="checkbox_wraper">
  ...
  </div> <p><?php echo $entry_newsletter; ?></p>
</div><!--END checkbox_wraper -->
...
<div class="checkbox_wraper">
  <div class="checkbox_belf">
    <input type="checkbox" value="1" name="shipping_address" id="shipping" checked="checked"/>
    <label for="shipping"></label> 
  </div> <p><?php echo $entry_shipping; ?></p>
</div>
<!-- <div class="checkbox">
  <label>
...
<div class="buttons clearfix">
  <div class="buttons"><?php echo $text_agree; ?> &nbsp;
    ...
    <div class="checkbox_belf">
      <input type="checkbox" value="1" name="agree" id="agree1"/>
      <label for="agree1"></label> 
    </div> 

    <!-- <input type="checkbox" name="agree" value="1" /> -->
    <button id="button-register" data-loading-text="<span class='button-outer'><span class='button-inner'><?php echo $text_loading; ?></span></span>" class="button_blue button_set"><span class="button-outer"><span class="button-inner"><?php echo $button_continue; ?></span></span></button>
