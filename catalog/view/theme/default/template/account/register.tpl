      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <fieldset>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-12">
              <label class="control-label"><?php echo $entry_newsletter; ?></label><br />
              <div class="wrap_radio">
              <?php if ($newsletter) { ?>

             
                <div class="radio">
                  <input id="male" type="radio" name="newsletter" value="1" checked="checked">
                  <label for="male"><?php echo $text_yes; ?></label>
                  <input id="female" type="radio" name="newsletter" value="0">
                  <label for="female"><?php echo $text_no; ?></label>
                </div>
              <?php } else { ?>
        ...
        <div class="buttons">
          <?php echo $text_agree; ?>
            ...
            <div class="checkbox_belf">
              <input type="checkbox" value="1" id="checkbox_belf" name="agree" checked="checked"/>
              <label for="checkbox_belf"></label>
            </div>
            <?php } else { ?>
            <div class="checkbox_belf">
              <input type="checkbox" value="1" id="checkbox_belf" name="agree" />
              <label for="checkbox_belf"></label>
            </div>
            <?php } ?>
            &nbsp;
