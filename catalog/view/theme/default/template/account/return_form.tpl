        ...
        <fieldset>
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              ...
              <div class="wrap_radio_return">
                <div class="radio">
                  <input id="return_reason_id_<?php echo $return_reason['return_reason_id']; ?>" type="radio" name="return_reason_id" value="<?php echo $return_reason['return_reason_id']; ?>" checked="checked">
                  <label for="return_reason_id_<?php echo $return_reason['return_reason_id']; ?>"><?php echo $return_reason['name']; ?></label> 
                </div>
              </div>
              ...
              <div class="wrap_radio_return">
                <div class="radio">
                  <input id="return_reason_id_1<?php echo $return_reason['return_reason_id']; ?>" type="radio" name="return_reason_id" value="<?php echo $return_reason['return_reason_id']; ?>" >
                  <label for="return_reason_id_1<?php echo $return_reason['return_reason_id']; ?>"><?php echo $return_reason['name']; ?></label> 
                </div>
              </div>
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <div class="wrap_radio_return">
                <div class="radio">
                  <?php if ($opened) { ?>
                  <input id="opened_" type="radio" name="opened" value="1" checked="checked" />
                  <?php } else { ?>
                  <input id="opened_" type="radio" name="opened" value="1" />
                  <?php } ?>
                  <label for="opened_"><?php echo $text_yes; ?></label> 
                </div>
              </div>
              ...
              <div class="wrap_radio_return">
                <div class="radio">
                  <?php if (!$opened) { ?>
                  <input id="opened_1" type="radio" name="opened" value="0" checked="checked" />
                  <?php } else { ?>
                  <input id="opened_1" type="radio" name="opened" value="0" />
                  <?php } ?>
                  <label for="opened_1"><?php echo $text_no; ?></label> 
                </div>
              </div>
              <!-- <label class="radio-inline">
                <?php if (!$opened) { ?>
