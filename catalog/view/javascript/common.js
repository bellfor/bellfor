...
$(document).ready(function() {
	...
	$('#list-view').click(function() {
			$('.container-Empfehlungen section').attr('class', 'row article-list-item');
    	$('.payment_buttons').attr('class', 'article-list-item-button payment_buttons');
      $('.article-list-item-delivery').attr('class', 'article-list-item-delivery');
			$('.article-list-item-main .description').attr('class', 'description');			
			$('.product-list-image').attr('class', 'product-list-image col-md-3 col-sm-3');
			$('.product-container').attr('class', 'col-md-9 col-sm-9 product-container');	
			$('span.tax').attr('class', 'small tax');			
	...
	function heightBlock(column){
		...
		column.css("min-height",myblock+"px");		
	};
	// Product Grid
	$('#grid-view').click(function() {
		$('.container-Empfehlungen section').attr('class', 'article-grid-item col-md-3 col-sm-3  Empfehlungen-img');
		...
		$.ajax({
			...
			success: function(json) {
				...
				if (json['success']) {
					...
					setTimeout(function () {
						$('#cart-items').text(json['total']);
					}, 100);

					$('html, body').animate({ scrollTop: 0 }, 'slow');

					$('#cart > div.product_menu').load('index.php?route=common/cart/info div#cart-info');
				}
			},
