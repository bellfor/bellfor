  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-sisowwg" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-sisowwg" class="form-horizontal">
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="text" name="sisowwg_merchantid" value="<?php echo $sisowwg_merchantid; ?>" placeholder="<?php echo $entry_merchantid; ?>" id="input-merchantid" class="form-control" />
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="text" name="sisowwg_merchantkey" value="<?php echo $sisowwg_merchantkey; ?>" placeholder="<?php echo $entry_merchantkey; ?>" id="input-merchantkey" class="form-control" />
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="sisowwg_shopid" value="<?php echo $sisowwg_shopid; ?>" placeholder="<?php echo $entry_shopid; ?>" id="input-shopid" class="form-control" />
            </div>
          </div>
          <hr>
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="sisowwg_status_success" id="input-order-status" class="form-control">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="sisowwg_testmode" id="input-status" class="form-control">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="sisowwg_total" value="<?php echo $sisowwg_total; ?>" placeholder="<?php echo $entry_total; ?>" id="input-total" class="form-control" />
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="sisowwg_totalmax" value="<?php echo $sisowwg_totalmax; ?>" placeholder="<?php echo $entry_totalmax; ?>" id="input-totalmax" class="form-control" />
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-geo-zone"><?php echo $entry_geo_zone; ?></label>
            <div class="col-sm-10">
              <select name="sisowwg_geo_zone_id" id="input-geo-zone" class="form-control">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="sisowwg_status" id="input-status" class="form-control">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="sisowwg_sort_order" value="<?php echo $sisowwg_sort_order; ?>" placeholder="<?php echo $entry_sort_order; ?>" id="input-sort-order" class="form-control" />
            </div>
          </div>
       </div>
