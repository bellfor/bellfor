...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		if ($product_info) {
			...
			// ADD Text //fixed by oppo webiprog.com  21.12.2017 // MAR-109
			$data['text_artikel_number'] = $this->language->get('text_artikel_number');
			$data['text_artikel_nummer_short'] = $this->language->get('text_artikel_nummer_short');
			$data['text_staffelpreise'] = $this->language->get('text_staffelpreise');
			$data['text_peace'] = $this->language->get('text_peace');
			$data['text_peace_short'] = $this->language->get('text_peace_short');
			$data['text_pro_kg'] = $this->language->get('text_pro_kg');
			$data['text_versand'] = $this->language->get('text_versand');
			$data['text_mwst'] = $this->language->get('text_mwst');
			$data['text_mwst_full'] = $this->language->get('text_mwst_full');
			$data['text_je'] = $this->language->get('text_je');
			// END ADD Text //fixed by oppo webiprog.com  21.12.2017 // MAR-109
...
//					$image = $this->model_tool_image->resize('placeholder.png', $this->config->get('config_image_related_width'), $this->config->get('config_image_related_height'));
			...
			if (($this->config->get('config_customer_price') && $this->customer->isLogged()) || !$this->config->get('config_customer_price')) {
				...
				$module_price = $this->currency->format($this->tax->calculate($product_info['price'], $product_info['tax_class_id'], $this->config->get('config_tax')), '', '', false);
			} else {
				$module_price = false;
			}

			$data['priceregion'] = $this->load->controller('module/priceregion', array('price' => $module_price, 'special' => $data['special']));
			//END fixed by oppo webiprog.com  28.02.2018 MAR-209

			$data['zz_store_id'] = $this->config->get('config_store_id');			
